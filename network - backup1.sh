...
CHAINCODE_COMMON_NAME=reference/chaincode_example02.go
CHAINCODE_BILATERAL_NAME=relationship
CHAINCODE_COMMON_INIT='{"Args":["KDL218976","111111","VINOTH","CHALLA","0","ORD1111","M","FOXCONN-MEXICO","2017-12-12"]}'
CHAINCODE_BILATERAL_INIT='{"Args":["KDL218976","111111","VINOTH","CHALLA","0","ORD1111","M","FOXCONN-MEXICO","2017-12-12"]}'
...
function devInstantiate () {
  docker-compose -f ${COMPOSE_FILE_DEV} run cli bash -c "peer chaincode instantiate -n mycc -v 0 -C myc -c '{\"Args\":[\"KDL218976\",\"111111\",\"VINOTH\",\"CHALLA\",\"0\",\"ORD1111\",\"M\",\"FOXCONN-MEXICO\",\"2017-12-12\"]}'"
}

function devInvoke () {
  docker-compose -f ${COMPOSE_FILE_DEV} run cli bash -c "peer chaincode invoke -n mycc -v 0 -C myc -c '{\"fcn\":\"move\",\"args\":[\"KDL218976\",\"111111\",\"VINOTH\",\"CHALLA\",\"0\",\"ORD1111\",\"M\",\"FOXCONN-MEXICO\",\"2017-12-12\"]}'"
}
